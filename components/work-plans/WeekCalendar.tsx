    ...
    <section className="surface-card p-4 sm:p-5">
      <div className="mb-3 flex items-center justify-between gap-2">
        ...
        <button
          ...
          className="control-focus -my-1 rounded-full px-3 py-1.5 text-sm font-medium text-accent active:bg-surface-secondary"
        >
          今週
        </button>
      </div>
            ...
            >
              ...
              <div className="flex flex-col gap-1.5 lg:flex-1">
                {dayPlans.map((plan) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="control-focus min-w-0 flex-1 rounded-r-[10px] py-2 pr-2 text-left transition-colors active:bg-surface-secondary"
                    >
                      <p
                ...
                <button
                  ...
                  className="control-focus flex min-h-11 items-center justify-center gap-1 rounded-[10px] border border-dashed border-separator-strong text-sm text-foreground-tertiary transition-colors active:bg-surface-secondary lg:mt-auto lg:min-h-9"
                >
